...
public enum ScytheMaterial implements ToolMaterial {
    ...
    @Override public float getAttackDamage() { return ScytheBalance.Base.MATERIAL_ATTACK_DAMAGE; }
    @Override public int getEnchantability() { return ScytheBalance.Base.ENCHANTABILITY; }
    @Override public int getMiningLevel() { return ScytheBalance.Base.MINING_LEVEL; }
