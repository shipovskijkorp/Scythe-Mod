...
public final class ScytheTooltips {
    ...
    public static void append(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
        if (stack.getItem() instanceof BloodScytheItem) blood(stack, world, tooltip, context);
        if (stack.getItem() instanceof ToxicScytheItem) toxic(stack, world, tooltip, context);
        if (stack.getItem() instanceof WitheringScytheItem) withering(stack, world, tooltip, context);
        if (stack.getItem() instanceof GoldenScytheItem) golden(stack, world, tooltip, context);
        if (stack.getItem() instanceof FrozenScytheItem) frozen(stack, world, tooltip, context);
        if (stack.getItem() instanceof FarmerScytheItem) farmer(stack, world, tooltip, context);
        if (stack.getItem() instanceof FireScytheItem) fire(stack, world, tooltip, context);
    }

    private static void blood(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    private static void toxic(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    private static void withering(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
        ...
        if (!alt) {
            ...
            TooltipUtil.addWrapped(tooltip, Text.translatable("tooltip.scythes.stat.minion_cap", String.valueOf(WitheringScytheItem.getMaxMinions(stack))), Formatting.GRAY);
    ...
    private static void golden(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    private static void frozen(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
    ...
    private static void fire(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
        TooltipUtil.addWrapped(tooltip, "tooltip.scythes.fire_scythe.desc", Formatting.GRAY, Formatting.ITALIC);
        if (!Screen.hasShiftDown()) { TooltipUtil.addHoldShiftHint(tooltip); return; }
        boolean alt = Screen.hasAltDown();
        ...
        if (!alt) { TooltipUtil.addWrapped(tooltip, "tooltip.scythes.fire_burst.desc", Formatting.GRAY); TooltipUtil.addHoldAltHint(tooltip); return; }
    ...
    private static void farmer(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
