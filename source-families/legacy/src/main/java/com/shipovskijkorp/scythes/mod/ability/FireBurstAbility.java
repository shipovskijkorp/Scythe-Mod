...
public final class FireBurstAbility {
    ...
    public static void tryActivate(ServerPlayerEntity player) {
        ...
        stack.damage(ScytheBalance.FireBurst.DURABILITY_COST, player, p -> p.sendToolBreakStatus(hand));
    ...
    private static void damageBurnableArmor(LivingEntity target) {
        for (EquipmentSlot slot : ARMOR_SLOTS) {
            ...
            armor.damage(ScytheBalance.FireBurst.ARMOR_DAMAGE, target, e -> e.sendEquipmentBreakStatus(slot));
        }
    }
