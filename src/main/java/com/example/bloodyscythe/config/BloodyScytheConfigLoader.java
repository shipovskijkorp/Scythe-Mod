...
public class BloodyScytheConfigLoader {
    ...
    public static BloodyScytheConfig getConfig() {
        if (CONFIG == null) {
    ...
    public static void load() {
        ...
        try {
            ...
            CONFIG = new BloodyScytheConfig();
            sanitize(CONFIG);
            BleedingMod.LOGGER.error("Failed to load config (using defaults){}",
                    configFile != null ? (": " + configFile.getName()) : "",
                    e);
        }
    }

    private static void sanitize(BloodyScytheConfig config) {
